 ...
 * This allows us to distinguish it from other errors across all vector database implementations
 */
export const COLLECTION_LIMIT_MESSAGE =
  "[Error]: Your vector database has hit its collection limit. To continue creating collections, you'll need to expand your capacity or manage existing collections.";
